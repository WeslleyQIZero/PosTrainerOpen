...
import com.wiseass.postrainer.adapter.ReminderListAdapter;
import com.wiseass.postrainer.model.objects.Reminder;
import com.wiseass.postrainer.ui.widget.CustomItemDecorator;
...
public class FragmentReminderList extends Fragment {
    ...
    public static FragmentReminderList newInstance(ArrayList<Reminder> listData) {
        FragmentReminderList fragment = new FragmentReminderList();

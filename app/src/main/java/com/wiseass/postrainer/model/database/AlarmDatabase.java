package com.wiseass.postrainer.model.database;
...
public class AlarmDatabase {
    ...
    public static AlarmDatabase getInstance(Context c) {
        if (mInstance == null) {
            mInstance = new AlarmDatabase(c);
        }
        return mInstance;

    }

    private AlarmDatabase(Context c) {
